...
**talks** ★218 (18488 kb)  <br>
_talks, talks, talks  (sources in Markdown)_


### 0xCompute _(6)_

**ethscribe** ★2 (14665 kb)  <br>
...
**bitcoin-maximalist** ★8 (1166 kb)  <br>
...
**bitcoin-whitepaper** ★10 (107 kb)  <br>
...
**ethereum-whitepaper** ★4 (334 kb)  <br>
...
**mastercoin-whitepaper** ★2 (181 kb)  <br>
_MasterCoin_
...
**awesome-cryptokitties-bubble** ★524 (5085 kb)  <br>
...
**awesome-mooncatrescue-bubble** ★14 (8830 kb)  <br>
...
**awesome-cryptopunks-bubble** ★120 (6011 kb)  <br>
...
**cryptopunksnotdead.github.io** ★10 (317 kb)  <br>
...
**programming-cryptopunks** ★421 (4562 kb)  <br>
...
**punks.attributes** ★62 (1067 kb)  <br>
...
**cache.factbook.json** ★8 (150585 kb)  <br>
...
**cache.api.fbdat** ★4 (872 kb)  <br>
_cached footballdata api match data_

**cache.footballdata** ★10 (2912 kb)  <br>
_Cache - Football-Data_

**cache.footballsquads** ★1 (18029 kb)  <br>
_Cache - Football Squads_
...
**cache.wfb** ★5 (2591 kb)  <br>
_cached worldfootball / weltfußball match data_
...
**mostly-adequate-guide-to-fp** ★18 (3620 kb)  <br>
...
**artfactory.sandbox** ★6 (3296 kb)  <br>
...
**book-classics-theme** ★5 (145 kb)  <br>
...
**awesome-blockchains** ★3735 (2593 kb)  <br>
...
**awesome-tetherino** ★51 (898 kb)  <br>
...
**programming-bitcoin-script** ★64 (475 kb)  <br>
...
**programming-blockchains** ★666 (553 kb)  <br>
...
**africa** ★5 (28 kb)  <br>
_Free open public domain football data (football.db) for Africa incl. Egypt, Morocco, Algeria, & more_

**austria** ★15 (1161 kb)  <br>
...
**awesome-football** ★200 (33 kb)  <br>
_A collection of awesome football (national teams, clubs, match schedules, players, stadiums, etc.) datasets_

**champions-league** ★36 (217 kb)  <br>
_Free open public domain football data for Champions League (incl. Qualifiers), Europa League / Europe_

**club-worldcup** ★3 (7 kb)  <br>
_Free open public domain football data (football.db) for the Club World Cup (Japan 2012, Morocco 2013, Morocco 2014, etc.)_

**clubs** ★50 (2814 kb)  <br>
_Free open public domain football data for the world's football clubs (& stadiums) - home of the clubs.db download / release_  <br>
`clubs` · `football` · `grounds` · `opendata` · `stadiums`

**copa-america** ★7 (76 kb)  <br>
_Free open public domain football data (football.db) for national teams in South America (e.g. Copa América)_  <br>
`copa` · `copa-america` · `copa2024`

**copa-america.json** ★4 (16 kb)  <br>
_Free open public domain football data for the Copa América in JSON incl. Copa América 2024 and more - No API key required ;-)_  <br>
`copa` · `copa-america` · `copa2024`

**deutschland** ★68 (2394 kb)  <br>
...
**euro** ★50 (266 kb)  <br>
_Free open public domain football data (euro.db) for Euro 2008, Euro 2012, Euro 2016, Euro 2020 (2021), Euro 2024, etc._  <br>
`euro` · `euro2020` · `euro2021` · `opendata` · `football` · `euro2024`

**euro.json** ★14 (399 kb)  <br>
_Free open public domain football data for the European Football Championship ("Euro") in JSON incl.  Euro 2024 and more - No API key required ;-)_  <br>
`euro` · `euro2020` · `euro2021` · `json` · `opendata` · `euro2024`

**europe** ★15 (963 kb)  <br>
_Free open public domain football data for Europe (incl. France, Netherlands, Belgium, Russia, Ukraine, and much more)_

**football.json** ★735 (2617 kb)  <br>
...
**italy** ★37 (840 kb)  <br>
_Free open public domain football data (football.db) for Italy / Europe - Serie A, Serie B, Coppa Italia, etc._  <br>
`opendata` · `football` · `seriea` · `italia` · `italy` · `juve` · `inter` · `napoli` · `roma` · `sqlite`

**league-starter** ★14 (59 kb)  <br>
_football.db league quick starter sample - start your own leagues & cups_

**leagues** ★39 (745 kb)  <br>
_Free open public domain football datasets for national & international football club leagues & cups from around the world - home of the leagues.db download/release_  <br>
`cups` · `football` · `leagues` · `opendata`
...
**openfootball.github.io** ★143 (1661 kb)  <br>
_Open Football Data (football.db) Website_

**players** ★26 (1184 kb)  <br>
_Free open public domain football data (football.db) for players (goalkeepers, defenders, midfielders, forwards) - home of the players.db download / release_  <br>
`football` · `opendata` · `players`

**quick-starter** ★76 (42 kb)  <br>
...
**sandbox** ★29 (59 kb)  <br>
_sandbox - misc (open) football data & scripts_
...
**south-america** ★77 (459 kb)  <br>
_Free open public domain football data (football.db) for South America (incl. Brazil, Argentina, Colombia, and much more)_

**spec** ★2 (48 kb)  <br>
_Football.TXT Format Spec (& Tests)_

**v0-format** ★4 (1266 kb)  <br>
_format v0 classics - misc. match schedules and more in the historic / classic v0 football.txt (prototype) format variants_

**world** ★4 (708 kb)  <br>
_Free open public domain football data incl. major leagues from North America, Asia, Australia and much more_

**worldcup** ★545 (707 kb)  <br>
...
**punkart.blocks.readymade** ★2 (60 kb)  <br>
...
**opensport.github.io** ★46 (1181 kb)  <br>
_Open Sports Data (sport.db) Web Site_

**rugby.db** ★5 (156 kb)  <br>
...
**nodepunks** ★17 (296 kb)  <br>
_Node Punks_  <br>
`24px` · `bitcoin` · `inscriptions` · `ordinals` · `punks` · `nodepunks`

**orc721.github.io** ★6 (694 kb)  <br>
...
**generative-orc-721** ★44 (4512 kb)  <br>
...
**ordbase.github.io** ★55 (8466 kb)  <br>
...
**ordinals.sandbox** ★15 (6140 kb)  <br>
...
**ordinalpunks.starter** ★9 (292 kb)  <br>
...
**artbase.sandbox** ★19 (92369 kb)  <br>
...
**moonbirds.sandbox** ★14 (22093 kb)  <br>
...
**austria** ★1 (523 kb)  <br>
_football.db RSSSF (Rec.Sport.Soccer Statistics Foundation) Archive Data for Austria (Österreich) / Europe - Österr. Bundesliga, Erste Liga, ÖFB Pokal etc._  <br>
`austria` · `football` · `rsssf`

**brazil** ★1 (1073 kb)  <br>
_football.db RSSSF (Rec.Sport.Soccer Statistics Foundation) Archive Data for Brazil (Brasil) - Campeonato Brasileiro Série A / Brasileirão etc._  <br>
`brazil` · `football` · `rsssf`

**deutschland** ★1 (2939 kb)  <br>
_  football.db RSSSF (Rec.Sport.Soccer Statistics Foundation) Archive Data for Germany (Deutschland) / Europe - Deutsche Bundesliga, 2. Bundesliga, 3. Liga, DFB Pokal etc._  <br>
`bundesliga` · `football` · `germany` · `rsssf`

**england** ★1 (841 kb)  <br>
_football.db RSSSF (Rec.Sport.Soccer Statistics Foundation) Archive Data for England / Europe - Premier League etc._  <br>
`football` · `rsssf` · `england`

**espana** ★2 (507 kb)  <br>
_football.db RSSSF (Rec.Sport.Soccer Statistics Foundation) Archive Data for España (Spain) / Europe - Primera División / La Liga, etc._  <br>
`football` · `rsssf` · `spain`

**rsssf.github.io** ★3 (52 kb)  <br>
...
**fifa** ★12 (108 kb)  <br>
_fifa - the world's football countries and codes (incl. non-member countries and irregular codes)_  <br>
`fifa` · `football` · `opendata` · `uefa`

**football.db** ★9 (231 kb)  <br>
...
**footty** ★15 (39 kb)  <br>
_footty - football.db command line tool for national & int'l football club leagues (& cups) from around the world (bonus - incl. world cup, euro and more)_  <br>
`worldcup` · `worldcup2018` · `russia2018` · `euro2020` · `euro2021` · `euro2024`

**sport.db** ★222 (3463 kb)  <br>
...
**sport.db.archive** ★15 (219 kb)  <br>
_sport.db.archive - more open sports database tools & libraries - incl. experimental (future) or older (archived) versions_

**sport.db.service** ★2 (10 kb)  <br>
_sport.db HTTP JSON API (web service) scripts_

**sport.db.sources** ★9 (215 kb)  <br>
...
**sport.db.starter.js** ★6 (259 kb)  <br>
_sportdb web service starter samples - build your own HTTP JSON API using the football.db, worldcup.db,  etc.  incl. football matchday tag / widget starters_
...
**world.db.starter** ★8 (29 kb)  <br>
_world.db quick starter apps & scripts_
...
**yukimotopress.github.io** ★10 (847 kb)  <br>
